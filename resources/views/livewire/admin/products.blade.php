...
<x-dialog-modal wire:model="confirmingProductDeletion">
    ...
    <x-slot name="footer">
        <button wire:click="deleteProduct({{ $product->id }})" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2">
            Yes, I'm sure
        </button>
        <button wire:click="$toggle('confirmingProductDeletion')" class="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center" data-modal-toggle="delete-product-modal">
            No, cancel
        </button>
    </x-slot>
 </x-dialog-modal>
